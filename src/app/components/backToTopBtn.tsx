...
export default function BackToTopBtn(props: any) {
    ...
    return (
        <div className={`transition-opacity duration-500 ease-in-out fixed bottom-5 right-5 z-50 ${hidden ? "opacity-0 pointer-events-none" : "opacity-100 pointer-events-auto"}`}>
