...
import { reasonsObjects, titoItemsObjects } from '@//Utils/reportSelectItems'
import Footer from '@//footer'
import initTranslations from '@//i18n'

export default function Report({ params }: { params: { locale: string } }) {
  ...
  const handleSelectChange = (selectedOptions: any, fieldName: any) => {
    setFormValues((prevState) => ({
      ...prevState,
  ...
  const handleSubmit = async (event: React.SyntheticEvent) => {
    ...
    if (!formValues.termsAccepted) {
      toast.error('Os termos devem ser aceitos!')
      return false
    }
                ...
                <div className="w-full px-10 mb-10  w-full">
                  <div className="flex flex-col  justify-center w-full text-center items-center w-full">
                    ...
                    <p className="text-gray-600 font-bold tracking-wider text-2xl py-5 pb-5">
                      {translate &&
                        translate.t &&
                        translate.t('DenunciationChannelHeader')}
                    </p>
                      ...
                      <div className="flex  justify-center items-center justify-center flex-col w-full">
                        ...
                        >
                          <p className="font-bold text-gray-100 ">
                            {translate &&
                              translate.t &&
                              translate.t(
                                'DenunciationChannelAnonymousReporting'
                              )}
                          </p>
                        </a>
                        <div className="flex justify-center text-center  items-center  mt-5 mb-5">
                          ...
                          <p className="ml-2  text-gray-800 font-bold">
                            {translate &&
                              translate.t &&
                              translate.t('DenunciationChannelHowToSendReport')}
                          </p>
                        </div>
                      </div>
                      <div className="flex  justify-center items-center justify-center flex-col w-full">
                        ...
                        >
                          <p className="font-bold text-gray-100 ">
                            {translate &&
                              translate.t &&
                              translate.t('DenunciationChannelAuditorCompany')}
                          </p>
                        </a>
                        <div className="flex justify-center text-center  items-center mt-5 mb-5">
                          <div className=" flex justify-center text-center  items-center  border rounded-full bg-tito-color h-[50px] w-[50px]">
                          ...
                          <p className="ml-2 text-gray-800 font-bold">
                            {translate &&
                              translate.t &&
                              translate.t('DenunciationRegisterRelat')}
                          </p>
                        </div>
                      </div>
                      <div className="flex  justify-center items-center justify-center flex-col w-full">
                        ...
                        >
                          <p className="font-bold text-gray-100 ">
                            {translate &&
                              translate.t &&
                              translate.t('DenunciationChannelAuditAnalysis')}
                          </p>
                        </a>
                        <div className="flex  justify-center text-center  items-center  mt-5 mb-5">
                          <div className=" flex  justify-center text-center  items-center  border rounded-full bg-tito-color h-[50px] w-[50px]">
                          ...
                          <p className="ml-2 text-gray-800 font-bold">
                            {translate &&
                              translate.t &&
                              translate.t('DenunciationChannelSecurity')}
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="flex flex-col justify-around w-full text-gray-600 font-bold bg-white py-5 tracking-wide text-2xl mt-10 mb-5">
                      {translate &&
                        translate.t &&
                        translate.t('DenunciationRegisterRelat')}
                      <div>
                        ...
                        <div className="text-start flex animate-fade-right px-4 mt-10 ">
                              ...
                              <p className="text-start  mt-5  text-sm">
                                <label className="inline-flex items-center  cursor-pointer">
                                  <input
                                    type="checkbox"
                                    name="termsAccepted"
                                    checked={formValues.termsAccepted} // Define o estado do checkbox com base no valor de formValues.termsAccepted
                                    onChange={(e) =>
                                      setFormValues((prevState) => ({
                                        ...prevState,
                                        termsAccepted: e.target.checked, // Atualiza o estado com o valor atual do checkbox
                                      }))
                                    }
                                ...
                                <div className="flex gap-2">
                                  <button
                                    ...
                                    className="flex mt-5 justify-center w-[100px]  px-5 py-2.5 text-sm font-medium text-end text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800"
                                  >
                                    Enviar
                                  </button>
                                </div>
